    ...
    <section className="p-3 md:p-auto my-16 bg-[--]">
      ...
      <div className=" rounded-3xl  flex flex-wrap h-[50%]  max-h-[50%] flex items-center justify-center ">
        {coursesData.map((course, index) => (
          <article key={index} className=" bg-[#424890] hover:bg-[#424809] m-2 p-2 lg:max-w-[30%] hover:bg-blue-950 hover:cursor-pointer transition rounded rounded-2xl min-w-screen ">
